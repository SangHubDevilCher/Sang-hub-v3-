...
SOMEXHUBMODILE.Name = "Sang Hub V3"
...
LogoHub.Image = "rbxassetid://16865469081"..tostring(15990445883)
...
function uitab:Tab(text,image)
    ...
    TabButton.TextTransparency = 0.500
        ...
        PageImage.Image = "rbxassetid://16865469081"..tostring(Image)
...
LogoToggle.Image = "rbxassetid://16865469081"..tostring(15990445883)
    ...
    function main:Dropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://15990445883"
...
local Library = Update:Window("Sang Hub V3","2.0",Enum.KeyCode.RightControl);
...
Main:Toggle("Cày Level(cấp)",_G.Setting_table.AutoFarm,function(vu)
Auto_Farm = vu
Auto_Fast_Farm = vu
...
Main:Toggle("Cày 600 thông thạo melee(võ)",_G.Setting_table.MasMelee,function(vu)
MasMelee = vu
...
Main:Toggle("Cày mob tự chọn",_G.Setting_table.Auto_Farm_Monster,function(vu)
...
Main:Toggle("Cày bone(xương)",_G.Setting_table.Farm_Bone,function(vu)
    Auto_Farm_Bone = vu
...
Main:Toggle("Cày katakuri(cake prince)",_G.Setting_table.Auto_Spikey_Trident,function(vu)
...
Main:Toggle("Cày katakuri v2(dough king)",_G.Setting_table.Prince2,function(vu)
    Prince2 = vu
...
Main:Toggle("Cày thông thạo trái(master fruit)",_G.Setting_table.Farm_Fruit,function(vu)
    Auto_Farm_Fruit = vu
...
Miscf:Toggle("Cày nguyên liệu(ingredient)",_G.Setting_table.AutoFarm_Meterial,function(vu)
...
Miscf:Toggle("Cày boss bí ẩn(elite)",_G.Setting_table.Auto_Elite_Hunter,function(vu)
...
Miscf:Toggle("Cày Tam Kiếm Zoro(three swords",_G.Setting_table.Triple_A,function(vu)
Auto_Farm_Sword = vu
Triple_A = vu
...
Miscf:Toggle("Cày điểm haki quan sát(ken)",_G.Setting_table.Farm_Ken,function(vu)
Farm_Ken = vu
